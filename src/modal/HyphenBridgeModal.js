...
function HyphenBridge(props) {
  ...
  let hyphen = new Hyphen(provider, {
    walletProvider: window.ethereum, // Pass this to enable network agnostic transfers
    biconomy: {
      enable: true,
      debug: true,
        ...
        <DialogContent style={{ overflowX: "hidden" }}>
          <div>
            ...
            >
              ...
              <DialogActions>
                <Grid  style={{textAlign:'center',margin:'10px auto'}} >
                  <Button
                    //   color="primary"
                    size="large"
                    type="submit"
                  ...
                  <h3 className="mt-3">Powered by Biconomy</h3>
                </Grid>
